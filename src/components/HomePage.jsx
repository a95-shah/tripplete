...
export default function HomePage({ className = "" }) {
 ...
 return (
  <div
    className={`relative w-full h-screen bg-[#faecba] flex flex-col items-center justify-center overflow-hidden ${className}`}
  >
    {/* SVG Filter for Hair — use unique id per instance */}
    <svg width="0" height="0" style={{ position: "absolute" }}>
      <filter id={filterId}>
   ...
   <div
      ...
      <img
        ...
        src="/door.svg"
        alt="Door"
        className="svg-icon w-[18vw] min-w-[150px] cursor-pointer"
        onClick={handleDoorClick}
      />
    </div>
    ...
    <div
      ref={iconsRef}
      className="absolute bottom-[3vw] right-[3vw] flex gap-[2vw]"
    >
      <a href="#" className="svg-icon text-orange-600 text-[clamp(2.5rem,4vw,5rem)]">
        <FaInstagram />
      </a>
      <a href="#" className="svg-icon text-orange-600 text-[clamp(2.5rem,4vw,5rem)]">
        <FaTiktok />
